        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Diseases Add</h4>
                            <div class="basic-form">
                                <form action="{{ route('admin.diseases.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="en_short_name" class="form-control @error('en_short_name') is-invalid @enderror" placeholder="English Short Name">
                                            @error('en_short_name')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="bn_short_name" class="form-control @error('bn_short_name') is-invalid @enderror" placeholder="বাংলা সংক্ষিপ্ত নাম">
                                            @error('bn_short_name')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="en_full_name" class="form-control @error('en_full_name') is-invalid @enderror" placeholder="English Full Name">
                                            @error('en_full_name')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="bn_full_name" class="form-control @error('bn_full_name') is-invalid @enderror" placeholder="বাংলা সম্পন্ন নাম">
                                            @error('bn_full_name')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="en_symptoms" id="enDescription"  ></textarea>
                                            @error('en_symptoms')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="bn_symptoms" id="bnDescription"  ></textarea>
                                            @error('bn_symptoms')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
