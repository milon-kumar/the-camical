                            ...
                            <div class="basic-form">
                                <form action="{{ route('admin.setting.update') }}" method="post">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <input type="hidden" name="types[]" value="about_en_description">
                                            <textarea class="form-control" name="about_en_description" id="" rows="4">{{ get_setting('about_en_description') }}</textarea>
                                        </div>
                                    </div>

                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                            <label for="">Bangla Description</label>
                                        </div>
                                        <div class="col-md-8">
                                            <input type="hidden" name="types[]" value="about_bn_description">
                                            <textarea class="form-control" name="about_bn_description" id="" rows="4">{{ get_setting('about_bn_description') }}</textarea>
                                        </div>
                                    </div>
